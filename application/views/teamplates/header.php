				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6 col-sm-8 col-xs-10">
							...
							<a href="<?php echo base_url();?>homepage/index"><i class="fa fa-apple fa-2x"></i></a>
							<a href="<?php echo base_url();?>homepage/index"><i class="fa fa-android fa-2x"></i></a>
							<a href="<?php echo base_url();?>homepage/index"><i class="fa fa-windows fa-2x"></i></a>
						</div>
						...
						<div class="col-md-6 col-sm-8 col-xs-10">
							<div class="log">
								<a href="<?php echo base_url();?>register/reg">Đăng Kí</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>login/log">Đăng Nhập</a>
							</div>

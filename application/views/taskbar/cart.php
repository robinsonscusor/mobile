					...
					<div class="row " >
						<form method="post">
							<table class="table table-hover tttk">
								...
								<?php   //if (count($cart) == 1) : ?>
									<!-- <tr>
									<td><?php echo $cart['sanpham'] ?></td>
									<td><?php echo $cart['gia'] ?> đ</td>
									<td><input type="text" name="sl" value="<?php echo $key['soluong'] ?>"></td>
									<td><?php echo $cart['thanhtien'] ?></td>

									<td>
			 							<td><a  href="<?php echo  base_url().'homepage/cart/'.$cart['sanpham'] ?>">
			 								<img style="width:20px;" src="<?php echo base_url(); ?>application/images/xoa.jpg" 
			 								onclick="return validateDelete();"></a></td>
									</td> -->
								...
								<tr>
									...
									<td>
			 							<td><a  href="<?php echo  base_url().'homepage/cart/'.$key['sanpham'] ?>">
			 								<img style="width:20px;" src="<?php echo base_url(); ?>application/images/xoa.jpg" 
			 								onclick="return validateDelete();"></a></td>
									</td>
